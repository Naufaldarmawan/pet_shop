 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Hewan Peliharaan Anda Layak Mendapatkan Yang Spesial</h1>
            <p class="lead fw-normal text-white-50 mb-0">Sedang mencari kebutuhan hewan peliharaan anda? Belanja sekarang!</p>
        </div>
    </div>
</header>
<!-- Section-->
